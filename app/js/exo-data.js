...
var EXO_DATA = (function () {
  ...
  var TABS_TOKO = [
    { id:'tberanda',  label:'Beranda',  d:'m3 10 9-7 9 7v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z' },
    { id:'tpesanan',  label:'Pesanan',  d:'M6 2h12v20l-3-2-3 2-3-2-3 2ZM9 8h6M9 13h6' },
    { id:'tproduk',   label:'Produk',   d:'M21 8 12 3 3 8v8l9 5 9-5V8ZM3 8l9 5 9-5M12 13v8' },
  ...
  var TAB_SCREENS = ['home','orders','wallet','profile','toko','wishlist','tokoFavorit','kuponSaya','notifikasi','pjadwal','cs','privasi','pinKelola','pjobs','pearn','pbelajar','tberanda','tpesanan','tproduk','tchat','tkeuangan','tprofil'];
  ...
  var JUMP_TOKO = [['tberanda','Seller Center'],['tpesanan','Pesanan toko'],['tproduk','Produk'],['tpromosi','Promosi'],['tiklan','Iklan toko'],['tprofil','Akun toko'],['tchat','Chat & ulasan'],['tkeuangan','Keuangan toko'],['keranjangDaftar','Keranjang'],['tstatistik','Statistik'],['tskor','Skor toko'],['tpengaturan','Pengaturan toko'],['tdaftar','Buka toko']];
