...
(function (X) {
  ...
  X.LAYAR.toko = function () {
    ...
    if (X.korselBanner && window.EXO_KONTEN && !K.tokoCari) h += X.korselBanner((EXO_KONTEN.baca('klien') || {}).bannerToko);
