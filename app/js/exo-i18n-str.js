...
(function (I) {
  ...
  L('Held now, charged when done', {id:'Ditahan sekarang, ditagih setelah selesai', ja:'今は保留、完了後に請求', ko:'지금은 보류, 완료 후 청구', zh:'现在预留，完成后扣款', ar:'يُحجز الآن ويُخصم بعد الإنجاز', ms:'Ditahan sekarang, dicaj selepas selesai', th:'กันวงเงินตอนนี้ เรียกเก็บเมื่อเสร็จ', vi:'Tạm giữ ngay, thu tiền khi hoàn tất', tl:'Naka-hold ngayon, sisingilin kapag tapos', km:'រក្សាទុកឥឡូវ គិតប្រាក់ពេលរួចរាល់', my:'ယခုထိန်းထား ပြီးမှကောက်ခံမည်'});
  L('Repeat this visit', {id:'Ulangi kunjungan ini', ja:'この訪問を繰り返す', ko:'이 방문 반복', zh:'重复此次服务', ar:'تكرار هذه الزيارة', ms:'Ulang lawatan ini', th:'ทำซ้ำการเข้าบริการนี้', vi:'Lặp lại lượt này', tl:'Ulitin ang pagbisitang ito', km:'ធ្វើម្តងទៀត', my:'ဤလာရောက်မှုကို ထပ်လုပ်ရန်'});
  L('One-off', {id:'Sekali', ja:'1回のみ', ko:'1회', zh:'单次', ar:'مرة واحدة', ms:'Sekali', th:'ครั้งเดียว', vi:'Một lần', tl:'Isang beses', km:'តែម្តង', my:'တစ်ကြိမ်တည်း'});
  L('Weekly', {id:'Mingguan', ja:'毎週', ko:'매주', zh:'每周', ar:'أسبوعياً', ms:'Mingguan', th:'รายสัปดาห์', vi:'Hàng tuần', tl:'Lingguhan', km:'រៀងរាល់សប្តាហ៍', my:'အပတ်စဉ်'});
  L('Every 2 weeks', {id:'Tiap 2 minggu', ja:'隔週', ko:'2주마다', zh:'每两周', ar:'كل أسبوعين', ms:'Setiap 2 minggu', th:'ทุก 2 สัปดาห์', vi:'2 tuần một lần', tl:'Tuwing 2 linggo', km:'រៀងរាល់ ២ សប្តាហ៍', my:'၂ ပတ်တစ်ကြိမ်'});
  L('Monthly', {id:'Bulanan', ja:'毎月', ko:'매월', zh:'每月', ar:'شهرياً', ms:'Bulanan', th:'รายเดือน', vi:'Hàng tháng', tl:'Buwanan', km:'រៀងរាល់ខែ', my:'လစဉ်'});
  L('off every visit', {id:'diskon tiap kunjungan', ja:'毎回割引', ko:'매 방문 할인', zh:'每次折扣', ar:'خصم على كل زيارة', ms:'diskaun setiap lawatan', th:'ส่วนลดทุกครั้ง', vi:'giảm mỗi lượt', tl:'diskwento bawat bisita', km:'បញ្ចុះតម្លៃរាល់ដង', my:'လာရောက်တိုင်း လျှော့စျေး'});
  L('Minimum', {id:'Minimal', ja:'最低', ko:'최소', zh:'最少', ar:'الحد الأدنى', ms:'Minimum', th:'ขั้นต่ำ', vi:'Tối thiểu', tl:'Minimum', km:'អប្បបរមា', my:'အနည်းဆုံး'});
  L('visits', {id:'kunjungan', ja:'回', ko:'회', zh:'次', ar:'زيارات', ms:'lawatan', th:'ครั้ง', vi:'lượt', tl:'bisita', km:'ដង', my:'ကြိမ်'});
  L('Cancel earlier and the discount on completed visits is charged back. Skipping a visit is free.', {id:'Batal lebih awal, diskon dari kunjungan yang sudah selesai ditagih kembali. Melewati satu kunjungan gratis.', ja:'早期解約時は完了済み訪問分の割引を請求します。1回のスキップは無料です。', ko:'조기 해지 시 완료된 방문의 할인분이 청구됩니다. 방문 건너뛰기는 무료입니다.', zh:'提前取消将追回已完成服务的折扣。跳过一次免费。', ar:'الإلغاء المبكر يسترد خصم الزيارات المكتملة. تخطي زيارة مجاني.', ms:'Batal lebih awal, diskaun lawatan yang selesai dicaj semula. Melangkau satu lawatan percuma.', th:'ยกเลิกก่อนกำหนด ส่วนลดของครั้งที่ทำแล้วจะถูกเรียกคืน ข้ามครั้งใดครั้งหนึ่งได้ฟรี', vi:'Hủy sớm sẽ thu lại phần giảm giá của các lượt đã xong. Bỏ qua một lượt là miễn phí.', tl:'Kapag kinansela nang maaga, sisingilin muli ang diskwento ng mga natapos na bisita. Libre ang paglaktaw ng isang bisita.', km:'បោះបង់មុនកំណត់ ការបញ្ចុះតម្លៃលើដងដែលរួចរាល់នឹងត្រូវគិតវិញ។ រំលងមួយដងឥតគិតថ្លៃ។', my:'စောစီးစွာပယ်ဖျက်ပါက ပြီးစီးသည့်အကြိမ်များ၏ လျှော့စျေးကို ပြန်ကောက်ခံမည်။ တစ်ကြိမ်ကျော်ခြင်းသည် အခမဲ့ဖြစ်သည်။'});
  L('Price locked for 3 months, same cleaner held for you.', {id:'Harga terkunci 3 bulan, petugas yang sama disimpan untuk Anda.', ja:'料金は3か月固定、同じスタッフを確保します。', ko:'3개월 가격 고정, 같은 클리너 배정 유지.', zh:'价格锁定3个月，为您保留同一清洁师。', ar:'السعر ثابت 3 أشهر ونحتفظ لك بنفس العامل.', ms:'Harga dikunci 3 bulan, pembersih sama dikekalkan untuk anda.', th:'ล็อกราคา 3 เดือน จองพนักงานคนเดิมให้คุณ', vi:'Giá cố định 3 tháng, giữ nguyên nhân viên cho bạn.', tl:'Naka-lock ang presyo sa loob ng 3 buwan, parehong tagalinis ang nakalaan sa iyo.', km:'តម្លៃចាក់សោ ៣ ខែ រក្សាអ្នកសម្អាតដដែលសម្រាប់អ្នក។', my:'၃ လ စျေးနှုန်းသတ်မှတ်ထားပြီး ဝန်ထမ်းတစ်ဦးတည်းကို သင့်အတွက် ထားပေးသည်။'});
  L('Weekly saves 10% per visit with a 4-visit minimum.', {id:'Mingguan hemat 10% tiap kunjungan, minimal 4 kunjungan.', ja:'毎週プランは毎回10%割引（最低4回）。', ko:'매주 플랜은 매 방문 10% 할인 (최소 4회).', zh:'每周计划每次省10%，最少4次。', ar:'الأسبوعي يوفر 10% لكل زيارة بحد أدنى 4 زيارات.', ms:'Mingguan jimat 10% setiap lawatan, minimum 4 lawatan.', th:'รายสัปดาห์ประหยัด 10% ต่อครั้ง ขั้นต่ำ 4 ครั้ง', vi:'Gói hàng tuần tiết kiệm 10% mỗi lượt, tối thiểu 4 lượt.', tl:'Ang lingguhan ay 10% mura bawat bisita, minimum na 4 na bisita.', km:'ប្រចាំសប្តាហ៍សន្សំ 10% ក្នុងមួយដង អប្បបរមា ៤ ដង។', my:'အပတ်စဉ်ဆိုလျှင် တစ်ကြိမ်လျှင် ၁၀% သက်သာပြီး အနည်းဆုံး ၄ ကြိမ်။'});
  L('Plan discount', {id:'Diskon paket', ja:'プラン割引', ko:'플랜 할인', zh:'计划折扣', ar:'خصم الخطة', ms:'Diskaun pelan', th:'ส่วนลดแพ็กเกจ', vi:'Giảm giá gói', tl:'Diskwento ng plano', km:'បញ្ចុះតម្លៃគម្រោង', my:'အစီအစဉ်လျှော့စျေး'});
  L('Held on', {id:'Ditahan di', ja:'保留先', ko:'보류 수단', zh:'预留于', ar:'محجوز على', ms:'Ditahan di', th:'กันวงเงินที่', vi:'Tạm giữ trên', tl:'Naka-hold sa', km:'រក្សាទុកនៅ', my:'ထိန်းထားသည့်နေရာ'});
  L('Held', {id:'Ditahan', ja:'保留中', ko:'보류', zh:'已预留', ar:'محجوز', ms:'Ditahan', th:'กันวงเงิน', vi:'Tạm giữ', tl:'Naka-hold', km:'បានរក្សាទុក', my:'ထိန်းထား'});
  L('charged when done', {id:'ditagih setelah selesai', ja:'完了後に請求', ko:'완료 후 청구', zh:'完成后扣款', ar:'يُخصم بعد الإنجاز', ms:'dicaj selepas selesai', th:'เรียกเก็บเมื่อเสร็จ', vi:'thu khi hoàn tất', tl:'sisingilin kapag tapos', km:'គិតប្រាក់ពេលរួចរាល់', my:'ပြီးမှကောက်ခံမည်'});
  L('Funds held', {id:'Dana ditahan', ja:'資金保留中', ko:'자금 보류 중', zh:'资金已预留', ar:'الأموال محجوزة', ms:'Dana ditahan', th:'กันวงเงินแล้ว', vi:'Tiền đang tạm giữ', tl:'Naka-hold ang pondo', km:'ថវិកាបានរក្សាទុក', my:'ငွေထိန်းထားသည်'});
  L('Charged', {id:'Ditagih', ja:'請求済み', ko:'청구됨', zh:'已扣款', ar:'تم الخصم', ms:'Dicaj', th:'เรียกเก็บแล้ว', vi:'Đã thu', tl:'Nasingil', km:'បានគិតប្រាក់', my:'ကောက်ခံပြီး'});
  L('Released', {id:'Dilepas', ja:'解除済み', ko:'해제됨', zh:'已释放', ar:'تم الإفراج', ms:'Dilepaskan', th:'คืนวงเงินแล้ว', vi:'Đã giải phóng', tl:'Nailabas na', km:'បានដោះលែង', my:'ပြန်လွှတ်ပြီး'});
  L('Visit', {id:'Kunjungan', ja:'訪問', ko:'방문', zh:'服务', ar:'زيارة', ms:'Lawatan', th:'ครั้งที่', vi:'Lượt', tl:'Bisita', km:'ដងទី', my:'အကြိမ်'});
  L('of minimum', {id:'dari minimal', ja:'／最低', ko:'/ 최소', zh:'/ 最少', ar:'من الحد الأدنى', ms:'daripada minimum', th:'จากขั้นต่ำ', vi:'trên tối thiểu', tl:'sa minimum na', km:'នៃអប្បបរមា', my:'အနည်းဆုံး'});
  L('Next visit', {id:'Kunjungan berikutnya', ja:'次回訪問', ko:'다음 방문', zh:'下次服务', ar:'الزيارة القادمة', ms:'Lawatan seterusnya', th:'ครั้งถัดไป', vi:'Lượt tiếp theo', tl:'Susunod na bisita', km:'ដងបន្ទាប់', my:'နောက်တစ်ကြိမ်'});
  L('Cancel plan', {id:'Batalkan paket', ja:'プランを解約', ko:'플랜 해지', zh:'取消计划', ar:'إلغاء الخطة', ms:'Batalkan pelan', th:'ยกเลิกแพ็กเกจ', vi:'Hủy gói', tl:'Kanselahin ang plano', km:'បោះបង់គម្រោង', my:'အစီအစဉ်ပယ်ဖျက်'});
  L('Commitment met — cancelling the plan is free.', {id:'Komitmen terpenuhi — membatalkan paket gratis.', ja:'最低回数達成済み — 解約は無料です。', ko:'약정 충족 — 플랜 해지는 무료입니다.', zh:'已满足承诺 — 取消计划免费。', ar:'تم الوفاء بالالتزام — إلغاء الخطة مجاني.', ms:'Komitmen dipenuhi — batalkan pelan percuma.', th:'ครบตามข้อผูกพันแล้ว — ยกเลิกแพ็กเกจฟรี', vi:'Đã đủ cam kết — hủy gói miễn phí.', tl:'Natupad ang commitment — libre ang pagkansela ng plano.', km:'បានបំពេញការប្តេជ្ញា — បោះបង់គម្រោងឥតគិតថ្លៃ។', my:'ကတိကဝတ်ပြည့်မီပြီ — အစီအစဉ်ပယ်ဖျက်ခြင်း အခမဲ့။'});
  L('Cancelling the plan now charges back the discount on completed visits:', {id:'Membatalkan paket sekarang menagih kembali diskon kunjungan yang sudah selesai:', ja:'今解約すると完了済み訪問分の割引を請求します：', ko:'지금 해지하면 완료된 방문의 할인분이 청구됩니다:', zh:'现在取消将追回已完成服务的折扣：', ar:'إلغاء الخطة الآن يسترد خصم الزيارات المكتملة:', ms:'Batalkan pelan sekarang mencaj semula diskaun lawatan yang selesai:', th:'ยกเลิกตอนนี้จะเรียกคืนส่วนลดของครั้งที่ทำแล้ว:', vi:'Hủy gói bây giờ sẽ thu lại phần giảm giá của các lượt đã xong:', tl:'Kapag kinansela ang plano ngayon, sisingilin muli ang diskwento ng mga natapos na bisita:', km:'បោះបង់គម្រោងឥឡូវនឹងគិតវិញនូវការបញ្ចុះតម្លៃលើដងដែលរួចរាល់៖', my:'ယခုပယ်ဖျက်ပါက ပြီးစီးသည့်အကြိမ်များ၏ လျှော့စျေးကို ပြန်ကောက်ခံမည်-'});
  L('Plan cancelled.', {id:'Paket dibatalkan.', ja:'プランを解約しました。', ko:'플랜이 해지되었습니다.', zh:'计划已取消。', ar:'تم إلغاء الخطة.', ms:'Pelan dibatalkan.', th:'ยกเลิกแพ็กเกจแล้ว', vi:'Đã hủy gói.', tl:'Nakansela ang plano.', km:'បានបោះបង់គម្រោង។', my:'အစီအစဉ်ပယ်ဖျက်ပြီး။'});
  L('Cancel booking', {id:'Batalkan pesanan', ja:'予約をキャンセル', ko:'예약 취소', zh:'取消预订', ar:'إلغاء الحجز', ms:'Batalkan tempahan', th:'ยกเลิกการจอง', vi:'Hủy đặt lịch', tl:'Kanselahin ang booking', km:'បោះបង់ការកក់', my:'ဘွတ်ကင်ပယ်ဖျက်'});
  L('Hold released to your EXO Wallet.', {id:'Dana yang ditahan dilepas ke EXO Wallet Anda.', ja:'保留額をEXOウォレットに解除しました。', ko:'보류 금액이 EXO 지갑으로 해제되었습니다.', zh:'预留资金已释放至您的EXO钱包。', ar:'تم الإفراج عن المبلغ المحجوز إلى محفظة EXO.', ms:'Dana ditahan dilepaskan ke EXO Wallet anda.', th:'คืนวงเงินที่กันไว้เข้า EXO Wallet แล้ว', vi:'Khoản tạm giữ đã trả về Ví EXO của bạn.', tl:'Nailabas na ang hold sa iyong EXO Wallet.', km:'ថវិកាដែលរក្សាទុកបានដោះលែងទៅ EXO Wallet របស់អ្នក។', my:'ထိန်းထားငွေကို သင့် EXO Wallet သို့ ပြန်လွှတ်ပြီး။'});
  L('Extras added to the hold — charged only when the visit is done.', {id:'Tambahan masuk ke dana yang ditahan — ditagih hanya setelah kunjungan selesai.', ja:'追加分を保留額に加算 — 完了後にのみ請求。', ko:'추가 작업이 보류액에 추가됨 — 완료 후에만 청구.', zh:'额外项目已加入预留 — 仅在完成后扣款。', ar:'أُضيفت الإضافات إلى المبلغ المحجوز — تُخصم بعد الإنجاز فقط.', ms:'Tambahan dimasukkan ke dana ditahan — dicaj hanya selepas selesai.', th:'เพิ่มรายการเสริมในวงเงินที่กัน — เรียกเก็บเมื่อเสร็จเท่านั้น', vi:'Phần thêm đã cộng vào khoản tạm giữ — chỉ thu khi hoàn tất.', tl:'Naidagdag ang extra sa hold — sisingilin lamang kapag tapos.', km:'ការបន្ថែមបានបញ្ចូលក្នុងថវិការក្សាទុក — គិតប្រាក់តែពេលរួចរាល់។', my:'အပိုများကို ထိန်းထားငွေထဲ ထည့်ပြီး — ပြီးမှသာ ကောက်ခံမည်။'});
  L('Confirm hold', {id:'Konfirmasi penahanan', ja:'保留を確定', ko:'보류 확인', zh:'确认预留', ar:'تأكيد الحجز', ms:'Sahkan penahanan', th:'ยืนยันการกันวงเงิน', vi:'Xác nhận tạm giữ', tl:'Kumpirmahin ang hold', km:'បញ្ជាក់ការរក្សាទុក', my:'ထိန်းထားမှု အတည်ပြု'});
  L('Enter PIN to hold', {id:'Masukkan PIN untuk menahan dana', ja:'PINを入力して保留', ko:'PIN 입력 후 보류', zh:'输入PIN以预留', ar:'أدخل الرمز للحجز', ms:'Masukkan PIN untuk menahan', th:'ใส่ PIN เพื่อกันวงเงิน', vi:'Nhập PIN để tạm giữ', tl:'Ilagay ang PIN para i-hold', km:'បញ្ចូល PIN ដើម្បីរក្សាទុក', my:'ထိန်းရန် PIN ထည့်ပါ'});
  L('held', {id:'ditahan', ja:'保留', ko:'보류', zh:'预留', ar:'محجوز', ms:'ditahan', th:'กันไว้', vi:'tạm giữ', tl:'naka-hold', km:'រក្សាទុក', my:'ထိန်းထား'});
  L('in total', {id:'total', ja:'合計', ko:'합계', zh:'合计', ar:'إجمالاً', ms:'jumlah', th:'รวม', vi:'tổng cộng', tl:'kabuuan', km:'សរុប', my:'စုစုပေါင်း'});
  L('Plan', {id:'Paket', ja:'プラン', ko:'플랜', zh:'计划', ar:'الخطة', ms:'Pelan', th:'แพ็กเกจ', vi:'Gói', tl:'Plano', km:'គម្រោង', my:'အစီအစဉ်'});
  L('Booking cancelled.', {id:'Pesanan dibatalkan.', ja:'予約をキャンセルしました。', ko:'예약이 취소되었습니다.', zh:'预订已取消。', ar:'تم إلغاء الحجز.', ms:'Tempahan dibatalkan.', th:'ยกเลิกการจองแล้ว', vi:'Đã hủy đặt lịch.', tl:'Nakansela ang booking.', km:'បានបោះបង់ការកក់។', my:'ဘွတ်ကင်ပယ်ဖျက်ပြီး။'});
  L('Late cancellation fee', {id:'Biaya pembatalan mendadak', ja:'直前キャンセル料', ko:'늦은 취소 수수료', zh:'临时取消费', ar:'رسوم الإلغاء المتأخر', ms:'Fi pembatalan lewat', th:'ค่าธรรมเนียมยกเลิกกระชั้นชิด', vi:'Phí hủy muộn', tl:'Bayad sa huling kanselasyon', km:'ថ្លៃបោះបង់យឺត', my:'နောက်ကျပယ်ဖျက်ကြေး'});
  L('Visit done — charged', {id:'Kunjungan selesai — ditagih', ja:'訪問完了 — 請求済み', ko:'방문 완료 — 청구됨', zh:'服务完成 — 已扣款', ar:'اكتملت الزيارة — تم الخصم', ms:'Lawatan selesai — dicaj', th:'เสร็จแล้ว — เรียกเก็บแล้ว', vi:'Đã xong — đã thu', tl:'Tapos na ang bisita — nasingil', km:'រួចរាល់ — បានគិតប្រាក់', my:'ပြီးစီး — ကောက်ခံပြီး'});
  L('Extras you approve on site are added to the hold.', {id:'Tambahan yang Anda setujui di lokasi masuk ke dana yang ditahan.', ja:'現地で承認した追加分は保留額に加算されます。', ko:'현장에서 승인한 추가 작업은 보류액에 추가됩니다.', zh:'您在现场批准的额外项目会加入预留。', ar:'الإضافات التي توافق عليها في الموقع تُضاف إلى المبلغ المحجوز.', ms:'Tambahan yang anda luluskan di lokasi dimasukkan ke dana ditahan.', th:'รายการเสริมที่คุณอนุมัติหน้างานจะเพิ่มในวงเงินที่กัน', vi:'Phần thêm bạn duyệt tại chỗ được cộng vào khoản tạm giữ.', tl:'Ang mga extra na aprubado mo sa lugar ay idaragdag sa hold.', km:'ការបន្ថែមដែលអ្នកយល់ព្រមនៅកន្លែងនឹងបញ្ចូលក្នុងថវិការក្សាទុក។', my:'နေရာတွင် သင်အတည်ပြုသော အပိုများကို ထိန်းထားငွေထဲ ထည့်မည်။'});
  L('Each visit is held at booking and charged when done.', {id:'Tiap kunjungan ditahan saat dipesan dan ditagih setelah selesai.', ja:'各訪問は予約時に保留、完了後に請求。', ko:'매 방문은 예약 시 보류, 완료 후 청구.', zh:'每次服务在预订时预留，完成后扣款。', ar:'كل زيارة تُحجز عند الحجز وتُخصم بعد الإنجاز.', ms:'Setiap lawatan ditahan semasa tempahan dan dicaj selepas selesai.', th:'แต่ละครั้งกันวงเงินตอนจอง เรียกเก็บเมื่อเสร็จ', vi:'Mỗi lượt được tạm giữ khi đặt và thu khi hoàn tất.', tl:'Bawat bisita ay naka-hold sa booking at sisingilin kapag tapos.', km:'រាល់ដងត្រូវរក្សាទុកពេលកក់ ហើយគិតប្រាក់ពេលរួចរាល់។', my:'လာရောက်မှုတိုင်းကို ဘွတ်ကင်ချိန်တွင် ထိန်းထားပြီး ပြီးမှကောက်ခံသည်။'});
  L('incl. extras', {id:'termasuk tambahan', ja:'追加分込み', ko:'추가 포함', zh:'含额外项目', ar:'شامل الإضافات', ms:'termasuk tambahan', th:'รวมรายการเสริม', vi:'gồm phần thêm', tl:'kasama ang extra', km:'រួមទាំងការបន្ថែម', my:'အပိုများအပါအဝင်'});
  L('paid through the gateway when done', {id:'dibayar lewat gateway setelah selesai', ja:'完了後にゲートウェイで支払い', ko:'완료 후 게이트웨이로 결제', zh:'完成后通过支付网关付款', ar:'يُدفع عبر البوابة بعد الإنجاز', ms:'dibayar melalui gateway selepas selesai', th:'ชำระผ่านเกตเวย์เมื่อเสร็จ', vi:'thanh toán qua cổng khi hoàn tất', tl:'babayaran sa gateway kapag tapos', km:'បង់តាមច្រកទូទាត់ពេលរួចរាល់', my:'ပြီးမှ gateway မှတစ်ဆင့် ပေးချေ'});
  L('No hold on this channel — you pay through the gateway once the visit is done.', {id:'Kanal ini tidak mendukung penahanan — Anda membayar lewat gateway setelah kunjungan selesai.', ja:'このチャネルは保留非対応 — 完了後にゲートウェイで支払います。', ko:'이 채널은 보류 불가 — 완료 후 게이트웨이로 결제합니다.', zh:'此渠道不支持预留 — 服务完成后通过支付网关付款。', ar:'لا حجز على هذه القناة — تدفع عبر البوابة بعد الإنجاز.', ms:'Saluran ini tiada penahanan — anda bayar melalui gateway selepas selesai.', th:'ช่องทางนี้กันวงเงินไม่ได้ — ชำระผ่านเกตเวย์เมื่อเสร็จ', vi:'Kênh này không tạm giữ — bạn thanh toán qua cổng khi hoàn tất.', tl:'Walang hold sa channel na ito — magbabayad ka sa gateway kapag tapos.', km:'ច្រកនេះមិនរក្សាទុកទេ — អ្នកបង់តាមច្រកទូទាត់ពេលរួចរាល់។', my:'ဤလမ်းကြောင်းတွင် ထိန်းထား၍မရ — ပြီးမှ gateway မှ ပေးချေမည်။'});
  L('Less than 4 hours before the start — cancelling costs Rp50.000 per cleaner.', {id:'Kurang dari 4 jam sebelum mulai — pembatalan dikenai Rp50.000 per petugas.', ja:'開始まで4時間未満 — キャンセル料はスタッフ1名につきRp50.000。', ko:'시작 4시간 미만 — 취소 시 클리너당 Rp50.000.', zh:'距开始不足4小时 — 取消每位清洁师收费Rp50.000。', ar:'أقل من 4 ساعات قبل البدء — الإلغاء يكلف Rp50.000 لكل عامل.', ms:'Kurang 4 jam sebelum mula — pembatalan dikenakan Rp50.000 setiap pembersih.', th:'น้อยกว่า 4 ชั่วโมงก่อนเริ่ม — ยกเลิกคิด Rp50.000 ต่อพนักงาน', vi:'Dưới 4 giờ trước khi bắt đầu — hủy mất Rp50.000 mỗi nhân viên.', tl:'Wala pang 4 na oras bago magsimula — Rp50.000 bawat tagalinis ang bayad sa pagkansela.', km:'តិចជាង ៤ ម៉ោងមុនចាប់ផ្តើម — បោះបង់អស់ Rp50.000 ក្នុងមួយអ្នកសម្អាត។', my:'စတင်ရန် ၄ နာရီမပြည့်မီ — ပယ်ဖျက်ပါက ဝန်ထမ်းတစ်ဦးလျှင် Rp50.000။'});
  L('More than 4 hours before the start — cancelling is free.', {id:'Lebih dari 4 jam sebelum mulai — pembatalan gratis.', ja:'開始まで4時間以上 — キャンセル無料。', ko:'시작 4시간 이상 전 — 취소 무료.', zh:'距开始超过4小时 — 取消免费。', ar:'أكثر من 4 ساعات قبل البدء — الإلغاء مجاني.', ms:'Lebih 4 jam sebelum mula — pembatalan percuma.', th:'มากกว่า 4 ชั่วโมงก่อนเริ่ม — ยกเลิกฟรี', vi:'Trên 4 giờ trước khi bắt đầu — hủy miễn phí.', tl:'Mahigit 4 na oras bago magsimula — libre ang pagkansela.', km:'ច្រើនជាង ៤ ម៉ោងមុនចាប់ផ្តើម — បោះបង់ឥតគិតថ្លៃ។', my:'စတင်ရန် ၄ နာရီကျော် — ပယ်ဖျက်ခြင်း အခမဲ့။'});
  L('Also cancel the plan', {id:'Batalkan paketnya juga', ja:'プランも解約する', ko:'플랜도 해지', zh:'同时取消计划', ar:'إلغاء الخطة أيضاً', ms:'Batalkan pelan juga', th:'ยกเลิกแพ็กเกจด้วย', vi:'Hủy cả gói', tl:'Kanselahin din ang plano', km:'បោះបង់គម្រោងផងដែរ', my:'အစီအစဉ်ကိုပါ ပယ်ဖျက်'});
  L('Keep the plan — only this visit', {id:'Pertahankan paket — hanya kunjungan ini', ja:'プランは維持 — この訪問のみ', ko:'플랜 유지 — 이번 방문만', zh:'保留计划 — 仅此次', ar:'الاحتفاظ بالخطة — هذه الزيارة فقط', ms:'Kekalkan pelan — lawatan ini sahaja', th:'คงแพ็กเกจไว้ — เฉพาะครั้งนี้', vi:'Giữ gói — chỉ lượt này', tl:'Panatilihin ang plano — ang bisitang ito lang', km:'រក្សាគម្រោង — តែដងនេះ', my:'အစီအစဉ်ထားရှိ — ဤတစ်ကြိမ်သာ'});
  L('Discount charge-back', {id:'Penarikan kembali diskon', ja:'割引の請求', ko:'할인 환수', zh:'折扣追回', ar:'استرداد الخصم', ms:'Caj semula diskaun', th:'เรียกคืนส่วนลด', vi:'Thu lại giảm giá', tl:'Pagsingil muli ng diskwento', km:'គិតវិញការបញ្ចុះតម្លៃ', my:'လျှော့စျေးပြန်ကောက်ခံမှု'});
  L('Next visit held', {id:'Kunjungan berikutnya ditahan', ja:'次回訪問分を保留', ko:'다음 방문 보류 완료', zh:'下次服务已预留', ar:'تم حجز الزيارة القادمة', ms:'Lawatan seterusnya ditahan', th:'กันวงเงินครั้งถัดไปแล้ว', vi:'Đã tạm giữ cho lượt tiếp theo', tl:'Naka-hold ang susunod na bisita', km:'បានរក្សាទុកដងបន្ទាប់', my:'နောက်တစ်ကြိမ် ထိန်းထားပြီး'});
  L('Cancelled', {id:'Dibatalkan', ja:'キャンセル済み', ko:'취소됨', zh:'已取消', ar:'ملغى', ms:'Dibatalkan', th:'ยกเลิกแล้ว', vi:'Đã hủy', tl:'Kanselado', km:'បានបោះបង់', my:'ပယ်ဖျက်ပြီး'});
  L('Visit done — the next one is scheduled', {id:'Kunjungan selesai — kunjungan berikutnya terjadwal', ja:'訪問完了 — 次回を予定済み', ko:'방문 완료 — 다음 방문 예약됨', zh:'服务完成 — 下次已排期', ar:'اكتملت الزيارة — تمت جدولة التالية', ms:'Lawatan selesai — seterusnya dijadualkan', th:'เสร็จแล้ว — นัดครั้งถัดไปแล้ว', vi:'Đã xong — lượt tiếp theo đã lên lịch', tl:'Tapos na — nakaiskedyul na ang susunod', km:'រួចរាល់ — ដងបន្ទាប់បានកំណត់', my:'ပြီးစီး — နောက်တစ်ကြိမ် စီစဉ်ပြီး'});
  L('Visits completed', {id:'Kunjungan selesai', ja:'完了した訪問', ko:'완료된 방문', zh:'已完成服务', ar:'الزيارات المكتملة', ms:'Lawatan selesai', th:'ครั้งที่ทำแล้ว', vi:'Lượt đã xong', tl:'Natapos na bisita', km:'ដងដែលរួចរាល់', my:'ပြီးစီးသည့်အကြိမ်'});
  L('Price locked until', {id:'Harga terkunci sampai', ja:'料金固定期限', ko:'가격 고정 기한', zh:'价格锁定至', ar:'السعر ثابت حتى', ms:'Harga dikunci sehingga', th:'ล็อกราคาถึง', vi:'Giá cố định đến', tl:'Naka-lock ang presyo hanggang', km:'តម្លៃចាក់សោរហូតដល់', my:'စျေးနှုန်းသတ်မှတ်ထားသည့်အထိ'});
  L('Recurring plans and holds', {id:'Paket berkala & penahanan dana', ja:'定期プランと保留', ko:'정기 플랜과 보류', zh:'定期计划与预留', ar:'الخطط المتكررة والحجوزات', ms:'Pelan berkala & penahanan', th:'แพ็กเกจประจำและการกันวงเงิน', vi:'Gói định kỳ và tạm giữ', tl:'Mga paulit-ulit na plano at hold', km:'គម្រោងប្រចាំ និងការរក្សាទុក', my:'ပုံမှန်အစီအစဉ်များနှင့် ထိန်းထားမှု'});
  ...
  /* Ketentuan paket berkala & penahanan dana (3 Sep 2026). */
  var ID_TAHAN = {
    'Weekly, fortnightly and monthly plans take 10%, 7% and 5% off every visit; the price is locked for 3 months and the same cleaner is held for you.':'Paket mingguan, dua mingguan, dan bulanan mendapat diskon 10%, 7%, dan 5% tiap kunjungan; harga terkunci 3 bulan dan petugas yang sama disimpan untuk Anda.',
    'Plans carry a minimum of 4 visits (3 for monthly). Cancelling earlier charges back the discount already received on completed visits; skipping a visit is free and does not count against the minimum.':'Paket memiliki komitmen minimal 4 kunjungan (3 untuk bulanan). Membatalkan lebih awal menagih kembali diskon yang sudah diterima pada kunjungan yang selesai; melewati satu kunjungan gratis dan tidak mengurangi komitmen minimal.',
    'For instant bookings the amount is held on your EXO Wallet or card at booking and charged only once the visit is confirmed done. Extras you approve on site are added to the hold. Cancelling releases the hold, less the late fee if within 4 hours.':'Untuk pesanan instan, jumlahnya ditahan di EXO Wallet atau kartu Anda saat memesan dan ditagih hanya setelah kunjungan dikonfirmasi selesai. Tambahan yang Anda setujui di lokasi masuk ke dana yang ditahan. Pembatalan melepas dana tersebut, dikurangi biaya pembatalan mendadak bila kurang dari 4 jam.'
  };
  Object.keys(ID_TAHAN).forEach(function (k) { ID[k] = ID_TAHAN[k]; });
  var ID_COOK = {
