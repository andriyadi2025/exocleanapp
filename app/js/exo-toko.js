...
var EXO_TOKO = (function () {
  ...
  function hitungKeranjang(items, kuponKode, kurirId, tarif, opsi) {
    ...
    Object.keys(perToko).forEach(function (tid) {
      ...
      g.asuransiAktif = (opsi.asuransi || {})[tid] !== false && kr.id !== 'ambil' && kr.id !== 'mitra'; g.asuransiHarga = Math.max(ATURAN.asuransiMin, bulat(g.subtotal * ATURAN.asuransiPct / 100, 500)); g.asuransi = g.asuransiAktif ? g.asuransiHarga : 0;
