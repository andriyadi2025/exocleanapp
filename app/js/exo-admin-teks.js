...
var EXO_ADMIN_TEKS = (function () {
  ...
  var T = {
    /* kelompok */
    'Operasional':{ en:'Operations' }, 'Marketplace':{ en:'Marketplace' }, 'Marketplace perlengkapan':{ en:'Supplies marketplace' }, 'Bayar & isi ulang (PPOB)':{ en:'Bills & top-up (PPOB)' }, 'Mitra':{ en:'Partners' }, 'Accounting & Finance':{ en:'Accounting & Finance' }, 'HRD':{ en:'HR' }, 'IT':{ en:'IT' },
    /* menu */
