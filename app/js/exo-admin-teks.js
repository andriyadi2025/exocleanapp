...
var EXO_ADMIN_TEKS = (function () {
  ...
  var T = {
    /* kelompok */
    'Operasional':{ en:'Operations' }, 'Marketplace':{ en:'Marketplace' }, 'Moderasi':{ en:'Moderation' }, 'Halaman & konten':{ en:'Pages & content' }, 'Pembelajaran & sertifikasi (LMS)':{ en:'Learning & certification (LMS)' }, 'Sertifikasi & kepatuhan':{ en:'Certification & compliance' }, 'Marketplace perlengkapan':{ en:'Supplies marketplace' }, 'Bayar & isi ulang (PPOB)':{ en:'Bills & top-up (PPOB)' }, 'H2H':{ en:'H2H' }, 'Kurir — Biteship':{ en:'Courier — Biteship' }, 'Bayar & isi ulang — Darmawisata':{ en:'Bills & top-up — Darmawisata' }, 'Perjalanan — Darmawisata':{ en:'Travel — Darmawisata' }, 'Mitra':{ en:'Partners' }, 'Accounting & Finance':{ en:'Accounting & Finance' }, 'HRD':{ en:'HR' }, 'IT':{ en:'IT' },
    /* menu */
