...
var KERANGKA = [
  ...
  './js/exo-screens-partner-kit.js',
  './js/exo-screens-partner-home.js',
  './js/exo-screens-partner-safety.js',
  './js/exo-keselamatan.js',
  './js/exo-flashdeal.js',
  './js/exo-cs.js',
  './js/exo-privasi.js',
  './js/exo-pin.js',
  ...
  './js/exo-sop.js',
  './js/exo-lms.js',
  './js/exo-lms-katalog.js',
  './js/exo-lms-sop.js',
  './js/exo-biaya.js',
  './js/exo-perlengkapan.js',
  './js/exo-invoice.js',
  './js/exo-invoice-halaman.js',
  './invoice.html',
  './js/exo-toko.js',
  './js/exo-iklan.js',
  './js/exo-konten.js',
  ...
  './js/exo-screens-toko2.js',
  './js/exo-screens-toko-iklan.js',
  './js/exo-screens-toko-profil.js',
  './js/exo-screens-akun.js',
  './js/exo-screens-home.js',
  './js/exo-screens-toko-produk.js',
  './js/exo-ppob.js',
  './js/exo-perjalanan.js',
  './js/exo-screens-perjalanan.js',
  './js/exo-screens-ppob.js',
  './js/exo-sheets.js',
  './js/exo-server.js',
  './js/exo-config.js',
  './js/exo-i18n-str.js',
  ...
  './js/exo-admin-akun.js',
  './js/exo-admin-brankas.js',
  './js/exo-admin-harga.js',
  './js/exo-vdp.js',
  './js/exo-admin-vdp.js',
  './js/exo-admin-pdp.js',
